...
export interface ISwoshInterface extends utils.Interface {
  functions: {
    ...
    "multiMegaTransfer((address[],address[],uint256[]),(address[],address[],uint256[]),(address[],address[],uint256[],uint256[]))": FunctionFragment;
  };
...
export interface ISwosh extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISwoshInterface;
