...
import type {
  ISwosh,
  ISwoshInterface,
} from "../../../contracts/interfaces/ISwosh";
...
export class ISwosh__factory {
  static readonly abi = _abi;
  static createInterface(): ISwoshInterface {
    return new utils.Interface(_abi) as ISwoshInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ISwosh {
    return new Contract(address, _abi, signerOrProvider) as ISwosh;
  }
}
